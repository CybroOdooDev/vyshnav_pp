# -*- coding: utf-8 -*-
{
    ...
    'depends': ['sale','contacts','intervlag_sale','intervlag_delivery_fedex'],
    'data': [
    ...
    'assets': {
        'web.assets_backend': [
            'intervlag_price_config/static/src/js/price_config_update.js',
            'intervlag_price_config/static/src/js/price_config_form_renderer.js',
        ],
    },
    'license': "AGPL-3",
    'images': [],
